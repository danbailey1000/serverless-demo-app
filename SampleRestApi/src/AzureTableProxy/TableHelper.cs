...
namespace AzureTableProxy
{
    ...
    public static class TableHelper
    {
        ...
        public static void RequestResource(string storageAccount, string accessKey, string resourcePath, out string jsonData)
        {
...
// Signature string for  Shared Key Lite Authentication must be in the form
      ...
      //.Add(new MediaTypeWithQualityHeaderValue("application/json"));//ACCEPT header
        ...
        //    request.Headers.Add("Content-Type", "application/json");
           // request.Content.Headers.Add("Content-Length", jsonData.Length.ToString());
